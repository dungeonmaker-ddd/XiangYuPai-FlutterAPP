...
List<SearchContentItem> _generateMockContentItems(String keyword) {
  return List.generate(10, (index) {
    return SearchContentItem(
      ...
      authorAvatar: 'https://picsum.photos/100/100?random=${index + 1}',
      images: index % 2 == 0 ? ['https://picsum.photos/300/200?random=${index + 100}'] : [],
...
List<SearchUserItem> _generateMockUserItems(String keyword) {
  return List.generate(8, (index) {
    return SearchUserItem(
      ...
      avatar: 'https://picsum.photos/80/80?random=${index + 200}',
